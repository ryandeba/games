...
urlpatterns = patterns('',
  ...
  url(r'^chess$', chess_views.index, name = "chess"),
  ...
  url(r'^cardsAgainstHumanity$', cah_views.index, name = "cardsAgainstHumanity"),

  url(r'^accounts/login/$', 'django.contrib.auth.views.login', {'template_name': 'common/login.html'}),
